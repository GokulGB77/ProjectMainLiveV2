...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setLeftValue() {
    ...
    amountLeft.innerText = Math.round((_this.value / 100000) * 100000); // Update the scaling factor
  }
  setLeftValue();
  ...
  function setRightValue() {
    ...
    amountRight.innerText = Math.round((_this.value / 100000) * 100000); // Update the scaling factor
